...
- Solves the problem of how outside programs interact with your program, or module-to-module communication.
- This means having functions from other programs that are called by functions in our program
- The API contains all the specifications needed to make use of, and to interact with different
	- Software modules,
	- Application libraries,
	- Local or remote computer systems, and even 
	- Internet based applications.
- API's do not bother us with their implementation of functionality if we don't want to see it
	- It allows us to use modules, libraries, or services w/o knowing the full details w/ how it's implemented
- Good API
	...
	- For documentation, consider that it is
		- Easy to find
		- Cleanly organized
		- Concise
		- No undefined  terms
