...
- Control of data / functions / what is visible to the user
	...
	- The compiler is what enforces access modifiers. It'll throw an error if you try to access things le wrong way.
...
- You CANNOT have two functions with identical signatures but different *return types* (the compiler will have no way of knowing which one to use)
![[Pasted image 20250420173441.png]]
^ This is false. Paco you cannot be spewing lies and misinformation like this!
### C++ syntax things
