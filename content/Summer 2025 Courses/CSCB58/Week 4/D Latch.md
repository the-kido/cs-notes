...
The design of the [[Clocked SR Latch]] is good but those "forbidden states" really suck. Lets get rid of them!
...
## Retrieving D-latch data (and Transparency)
...
- The path from out to in could be as simple as the inverter from above, or a proper combinational circuit. Regardless, the same problem can arise
