...
### [[Winter 2024/CSCA48 (C Lang)/Strings|Strings]]
...
A: Refer to [[Winter 2024/CSCA48 (C Lang)/Strings#String literals|this]]. TL:DR, string literals CANNOT be updated, so the bottom line is no-go.
...
### 2D [[Winter 2024/CSCA48 (C Lang)/Arrays|Arrays]]
