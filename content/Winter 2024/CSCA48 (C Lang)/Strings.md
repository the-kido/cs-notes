...
- Compares two strings. Returns 0 if they are equal and other numbers if they aren't. Similar to [[Java (2023)/Objects and Data Structures/Strings#compareTo()|compare() in Java]]
