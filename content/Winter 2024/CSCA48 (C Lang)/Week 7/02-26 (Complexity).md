...
Anyway after all of that, we can conclude that choosing a solution depends on your use case.
Note:
...
- d) BST's and linked-lists are more space efficient than arrays
Those will help you decide.
